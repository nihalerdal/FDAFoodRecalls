...
//    }
    ...
    class func getRecalls(completion: @escaping ([GetRecalls]?, Error?)-> Void ) {
        ...
        let parameters = "payLoad={\"displaycolumns\": \"firmlegalnam,firmcitynam,firmcountrynam,firmline1adr,firmline2adr,firmpostalcd,productid,productdescriptiontxt,productshortreasontxt,centerclassificationtypetxt,productdistributedquantity,phasetxt,centercd,rid\",\"filter\":\"[{'centercd':['CFSAN']},{'phasetxt':['ongoing']},{'centerclassificationtypetxt':['1']},{'firmcountrynam':'United States'}]\",\"start\": 1,\"rows\": 250, \"sort\": \"productid\", \"sortorder\": \"asc\"}"
